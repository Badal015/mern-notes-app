...
const Login = ({setUser}) => {
    ...
    return (
        <div className="container mx-auto max-w-md mt-10 p-6 bg-white rounded-lg shadow-md">
            <h2 className="text-2xl font-semibold text mb-6 text-center">Login</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button className="w-full bg-blue-500 rounded-md text-white py-2 hover:bg-blue-700">Login</button>
            </form>
